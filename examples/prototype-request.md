...
1. 创建 `REQ-20260616-001`。
2. 更新 `state/project-board.md`。
3. 创建产品任务：
   - `docs/tasks/TASK-20260616-001-PM.md`
4. 调度产品经理 Agent。
...
```text
docs/tasks/TASK-20260616-001-BE.md
docs/tasks/TASK-20260616-001-FE.md
docs/tasks/TASK-20260616-001-QA.md
```
